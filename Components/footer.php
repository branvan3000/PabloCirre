...
<footer class="main-footer">
    <div>
        ...
        <div class="legal-links">
            <a href="/PabloCirre/paginas/Legal/aviso-legal.php">Aviso Legal</a>
            <span>·</span>
            <a href="/PabloCirre/paginas/Legal/privacidad.php">Privacidad</a>
            <span>·</span>
            <a href="/PabloCirre/paginas/Legal/cookies.php">Cookies</a>
        </div>
    </div>
    <div class="footer-links">
        <a href="/PabloCirre/Labs/">Labs</a>
        ...
        <a href="/PabloCirre/paginas/About-Me/index.php">Contact</a>
    </div>
</footer>
...
<!-- JavaScript Modules -->
<script src="/PabloCirre/assets/js/main.js"></script>
<script src="/PabloCirre/assets/js/font-switcher.js"></script>
<script src="/PabloCirre/assets/js/musical-knobs.js"></script>
<script src="/PabloCirre/assets/js/mobile-nav.js"></script>
<script src="/PabloCirre/assets/js/cookie-consent.js"></script>
</body>
