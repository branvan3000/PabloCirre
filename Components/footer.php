...
<footer class="main-footer">
    ...
    <div class="footer-links">
        ...
        <a href="<?php echo BASE_URL; ?>/paginas/About-Me/index.php">Contact</a>
    </div>
</footer>
...
<script src="<?php echo BASE_URL; ?>/assets/js/font-switcher.js"></script>
<script src="<?php echo BASE_URL; ?>/assets/js/musical-knobs.js"></script>
